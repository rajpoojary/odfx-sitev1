...
const Vector88Icon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 346 310' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path
      ...
      fill='url(#paint0_linear_802_21102)'
      fillOpacity={0.6}
    />
    <defs>
      <linearGradient
        id='paint0_linear_802_21102'
        x1={255.5}
        y1={170.5}
        x2={183.896}
        y2={400.369}
...
const Memo = memo(Vector88Icon);
export { Memo as Vector88Icon };
